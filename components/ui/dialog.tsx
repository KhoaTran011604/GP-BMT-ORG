...
function DialogFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex flex-col-reverse gap-3 sm:flex-row sm:justify-end pt-6 border-t border-gray-200 mt-2',
        className,
      )}
      {...props}
    />
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn('text-xl sm:text-2xl leading-tight font-bold text-gray-900', className)}
      {...props}
    />
  )
}
